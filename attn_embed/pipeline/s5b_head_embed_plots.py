    ...
    if cfg.do_figures:
        ...
        try:
            ...
            fig, _ = plot_head_embeddings_multi(
                head_embed_df,
                color_by="type.group",
                methods=cfg.embedding_methods[:3],  # Limit to first 3 methods to avoid overcrowding
                sizes=(12, 6),
                figsize=(24, 32),
            )
            ...
            if plots_json_source.exists():
                ...
                print("Warning: head_embed_plots.json not found. Make sure s5_head_embed ran successfully.")
