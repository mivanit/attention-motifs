  ...
  let default_cfg = {
    ...
    colors: {
      ...
      viridisColors: {
        ...
        r: [0.267004, 0.10501, 0.33001, 2.4376, -5.1798, 2.0661],
        g: [0.004874, 0.40691, 1.1936, -1.3752, 0.8135, -0.0732],
        b: [0.329415, 0.71808, -0.7244, 0.0633, 0.0167, 0.0],
      },
    },
    ...
    rightClick: {
      ...
      url: {
        template:
          "https://example.com/{activation.cls}/{activation.model}?prompt={activation.prompt}&x={coord.x}&y={coord.y}&z={coord.z}",
      },
    },
