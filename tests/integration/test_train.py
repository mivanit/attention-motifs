...
from attention_motifs.dataset.util import AttentionPatternMetadataArray, AttentionPatternMetadata
from attention_motifs.dataset.dataset import AttentionPatternDataset, CollectedAttentionPatternDataloader
from attention_motifs.dataset.prompts import PromptDataset, PromptDatasetConfig
from attention_motifs.vit_ae import VitAE, VitAEConfig
...
def test_small_vit_ae_integration() -> None:
    ...
    patterns: Float[torch.Tensor, "n_patterns n_ctx n_ctx"] = torch.randn(n_patterns, n_ctx, n_ctx)
