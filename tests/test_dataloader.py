...
def build_fp_sample(
	dir_: Path, file_basename: str, data_4d: np.ndarray, meta_prefix: str = "sample"
) -> FPSample:
	"""
...
def test_fp_sample_metadata():
	...
	"""
	row0 = [
		SampleMetadata(n=4, sample_id="r0c0"),
		SampleMetadata(n=4, sample_id="r0c1"),
	]
	row1 = [
		SampleMetadata(n=4, sample_id="r1c0"),
		SampleMetadata(n=4, sample_id="r1c1"),
	]
