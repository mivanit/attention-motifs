...
.PHONY: am-setup
am-setup: dep am-data-download-pile am-setup-playwright _am-frontend-fetch-libs am-pipeline-download-models
...
am-frontend-bundle: _am-frontend-format _am-frontend-gen-ap _am-frontend-fetch-libs
	...
	$(PYTHON) -m muutils.web.bundle_html $(FRONTEND_DIR)/correlations/src/index.html --output $(FRONTEND_DIR)/correlations/index.html
